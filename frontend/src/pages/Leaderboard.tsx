  ...
  return (
    <div className="min-h-screen bg-paper animate-slide-down">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Your Rank */}
        {operatorRank && (
          <div className="mb-8 border-hard border-2 bg-text hard-shadow-lg">
            <div className="grid grid-cols-5 text-white font-mono font-bold text-sm py-4 px-6">
              <div>RNK</div>
              <div>CALLSIGN</div>
              <div>ACCURACY</div>
              <div>TOTAL_SCORE</div>
            ...
            <div className="bg-white border-t-2 border-hard">
              <div className="grid grid-cols-5 items-center py-4 px-6 bg-gray-100 border-2 border-text hard-shadow">
                <div className="font-mono font-bold text-lg">#{operatorRank.rank}</div>
